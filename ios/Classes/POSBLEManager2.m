...
#import "POSBLEManager2.h"
#import "BLEManager.h"

static POSBLEManager2 *shareInstance = nil;

@interface POSBLEManager2 ()<BLEManagerDelegate>
@property (nonatomic,strong) BLEManager *manager;
@end

@implementation POSBLEManager2
+ (instancetype)sharedInstance {
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        shareInstance = [[POSBLEManager2 alloc] init];
    });
